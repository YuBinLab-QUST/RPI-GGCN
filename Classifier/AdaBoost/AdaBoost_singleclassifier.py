...
data_start = pd.read_csv("RPI369_zz.csv")
...
data_csv_zhibiao.to_csv('zhibiao_AdaBoost.csv')
yscore_sum.to_csv('yscore_AdaBoost.csv')
ytest_sum.to_csv('ytest_AdaBoost.csv')