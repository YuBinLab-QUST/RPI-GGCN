# -*- coding: utf-8 -*-
"""
Created on Sun Apr 23 20:53:49 2023
...
data_train=pd.read_csv('RPI369_RNA_PN_ALL.csv')
...
giniresult = feature[feature.columns[idx[0:37]]]
giniresult.to_csv("RNA_GINI.csv")